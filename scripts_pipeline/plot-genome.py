...
def genome_plot(colors, genome_list, ordered=None):
    """
    ...
    for i in range(len(genome_list)):
        ...
        # accn = ordered[j]
        # string_list = [genome.accno for genome in genome_list]
        # i = string_list.index(accn)
...
def main():
    ...
    # Create genome plot
    #ordered genomes
    #ordered = read_col("/home/laura/Projects/ovrf-review/plot_data/rhabdoviridae/accessions.txt")
    gen_plot = genome_plot(colors, genome_list)
    print("save genome")
    gen_plot.savefig(f'genome_{args.outfile}.pdf', dpi=600)
