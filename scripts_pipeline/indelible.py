"""
-*- coding: utf-8 -*- 
NAME [indelible_v2.py]	Version [2.0]
CREATED (2024-02)
USAGE python3 indelible.py -f random_tree.tree  -o control_file.txt 
DESCRIPTION
Generate the control file to run INDElibLe 
Input tree should have numerical distances 
"""
...
requiredNamed.add_argument('-f', '--file', help='Input the tree')
requiredNamed.add_argument('-o', '--output', help='Output file path')
requiredNamed.add_argument('-s', '--scaling_factor', type = int, default=20,
...
with open(args.output, 'w') as handle:
    ...
    handle.write('[EVOLVE] partitionname 1 output_file \n' ) 
