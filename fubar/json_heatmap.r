...
#title
name <- gsub("/home/sareh/surfaces/find_cds/working2/FUBAR/cutter_cds_","",json_path)
name <- gsub(".FUBAR.json","",name)
...
ggplot(grid.factor, aes(grid.factor$dN, grid.factor$dS, fill= grid.factor$posterior)) +
